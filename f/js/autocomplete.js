...
function setArr(argument) {
 console.log($(v).val().charAt(0)+"*************");
  ...
  else if($(v).val().charAt(0)=='#') return countriesh; 
  ...
  function updatelist(argument) {
            ...
            if(argument==0&&$(v).val().charAt(0)=='@'){
                ...
                $('#search_res').append(' <li class="nonexpandable"><span class="search_res_text">#SearchRes</span><a  onclick="moresearchresult(this)" class="more"></a><a onclick="sharesearchresult(this)" class="share"><small><span class="icon-share"></span></small></a> <a onclick="addsearchresult(this)" class="add"></a> </li>');
